            ...
            <div class="row g-0">
                ...
                <div class="col-md-6 bg-dark d-flex align-items-center">
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        <h5 class="section-title ff-secondary text-start text-primary fw-normal">Commande</h5>
                        <h1 class="text-white mb-4">Commander maintenant</h1>
                        <form action="/ordering" method="POST">
                            @csrf
                            <input type="hidden" name="idPlat" value="{{$details->idPlat}}">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="adresse" name="adresseLivraison" placeholder="adresse Livraison">
                                        <label for="adresse">adresse Livraison</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="date" class="form-control" id="date" name="idDate" placeholder="Date">
